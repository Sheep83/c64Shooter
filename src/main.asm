...
#import "generated/stage_config.asm"

// Authored turret PLACEMENT, generated by tools/level_editor. Constants +
// assembler lists only (no bytes/segment/PC). Owns TURRET_COUNT, turretCols and
// turretRows (world CHARACTER columns/rows, full 16-bit stage height). Imported
// early so TURRET_COUNT resolves for updateTurretPressure. All turret BEHAVIOUR
// (AI, cadence, HP, rendering, activation, collision) stays in
// src/background_turrets.asm, which validates this placement data.
#import "generated/stage_turrets.asm"
...
updateTurretPressure:
    ldx #TURRET_COUNT - 1                   // TURRET_COUNT is generated (stage_turrets.asm) and imported
                                            // early, so it resolves here. 1..3 (glyph namespace).
!scan:
...
* = $6600
#import "generated/stage_test.asm"

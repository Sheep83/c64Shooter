...
.var VIC_CONTROL_2           = $d016     // MCM / CSEL / XSCROLL. Playfield uses global MC text mode.
.var EXTRA_COLOUR_1          = $d022     // Shared multicolour bit-pair "01" (terrain shade 1).
.var EXTRA_COLOUR_2          = $d023     // Shared multicolour bit-pair "10" (terrain shade 2).
